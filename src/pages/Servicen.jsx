...
import PaperCardse from "../components/PaperCardse";

const urlBase = "http://localhost:5000/servicen";

const Servicen = () => {
  const [servicens, setServicens] = useState(null);
